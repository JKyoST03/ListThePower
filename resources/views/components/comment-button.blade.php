<button {{ $attributes->merge(['class' => 'group']) }}>
    <svg width="64px" height="39px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
        xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000">
        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
        <g id="SVGRepo_iconCarrier">
            <defs>
                <polygon id="comment-a" points="0 0 19 0 19 3 16.637 3 15.732 7.26 10.79 3 0 3"></polygon>
                <path id="comment-c"
            ...
            <g fill="none" fill-rule="evenodd" transform="translate(1 3)">
                <g transform="translate(2 12)">
                    <mask id="comment-b" fill="#ffffff">
                        <use xlink:href="#comment-a"></use>
                    </mask>
                    <use fill="#D8D8D8" xlink:href="#comment-a"></use>
                    <g class="transition-colors duration-300 group-hover:fill-[#d71d1d]" fill="#292524" mask="url(#comment-b)">
                        <rect width="24" height="24" transform="translate(-3 -15)"></rect>
                    </g>
                </g>
                <mask id="comment-d" fill="#bfbfbf">
                    <use xlink:href="#comment-c"></use>
                </mask>
                <use class="transition-colors duration-300 group-hover:fill-red-400" fill="#000000" fill-rule="nonzero" xlink:href="#comment-c"></use>
                <g fill="#ffffff" mask="url(#comment-d)">
                    <rect width="24" height="24" transform="translate(-1 -3)"></rect>
                </g>
            </g>
        </g>
    </svg>
